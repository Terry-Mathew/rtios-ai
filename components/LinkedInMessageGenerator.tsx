...
import { Send, Copy, RefreshCw, Check, Info, User, MessageSquare, PenTool, ChevronDown } from 'lucide-react';
          ...
          <div className="mb-8">
            ...
            <div className="flex p-1 bg-surface-base rounded-lg border border-white/5">
              <button
                ...
                className={`flex-1 py-2.5 text-xs font-interstate font-bold uppercase tracking-wide rounded-md transition-all ${
              ...
              <button
                ...
                className={`flex-1 py-2.5 text-xs font-interstate font-bold uppercase tracking-wide rounded-md transition-all ${
                  input.connectionStatus === 'existing' 
                    ? 'bg-accent text-surface-base shadow-lg' 
                    : 'text-text-secondary hover:text-text-primary'
                }`}
              >
               ...
               <div className="flex flex-wrap gap-2">
                    {['Warm Professional', 'Professional', 'Casual Confident', 'Industry-Specific'].map((tone) => (
                        <button
                            ...
                            className={`py-2 px-3 rounded text-[10px] font-interstate font-bold uppercase tracking-wide transition-all ${
                                input.tone === tone
                                ? 'bg-accent text-surface-base shadow-lg'
