                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/pricing" className="font-interstate text-sm text-text-secondary hover:text-text-primary transition-colors">
                                    Pricing
                                </Link>
                            </li>
                            <li>
                                <Link to="/about" className="font-interstate text-sm text-text-secondary hover:text-text-primary transition-colors">
                                    About
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/terms" className="font-interstate text-sm text-text-secondary hover:text-text-primary transition-colors">
                                    Terms of Service
                                </Link>
                            </li>
                            <li>
                                <Link to="/privacy" className="font-interstate text-sm text-text-secondary hover:text-text-primary transition-colors">
                                    Privacy Policy
                                </Link>
                            </li>
                            <li>
                                <Link to="/cookie" className="font-interstate text-sm text-text-secondary hover:text-text-primary transition-colors">
                                    Cookie Policy
                                </Link>
                            </li>
                        </ul>
